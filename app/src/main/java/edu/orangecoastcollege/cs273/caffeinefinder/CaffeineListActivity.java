...
//DONE: GoogleApiClient.ConnectionCallback, GoogleApiClient.OnConnectionFailedListener and LocationListener
public class CaffeineListActivity extends AppCompatActivity
    ...
    public static final int COURSE_LOCATION_REQUEST_CODE = 100;
    private DBHelper db;
    ...
    //Google API client is "fused" services for all apps on the device (location, map, store)
    ...
    public void onConnected(@Nullable Bundle bundle) {
        ...
        if (ActivityCompat.checkSelfPermission(this, Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED && ActivityCompat.checkSelfPermission(this, Manifest.permission.ACCESS_COARSE_LOCATION) != PackageManager.PERMISSION_GRANTED) {
            ...
            //Don't have either COARSE or FINE permission, so request them:
            ActivityCompat.requestPermissions(this,new String[] {Manifest.permission.ACCESS_FINE_LOCATION}, COURSE_LOCATION_REQUEST_CODE );
            return;
        }
    ...
    public void findClosestCaffeine(View v)
    {
        ...
        //Loop through the list of caffeine
